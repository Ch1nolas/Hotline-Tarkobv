...
IL2CPP_EXTERN_C String_t* _stringLiteral5526E05109630C0E260028AD6D6D0A7DB25F0BF3;
...
IL2CPP_EXTERN_C String_t* _stringLiteral99931AC25F6D28C7349F672724384FD0D4F76340;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void enemy_Update_m20DA17E1B3831C3DB29FE11CE3AA5A3794168F2E (enemy_tE47B2B7194CDCEE956D24274FB1629917AE4AFE9* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		float L_11 = __this->___movementSpeed_5;
...
{
	{
		...
		__this->___movementSpeed_5 = (5.0f);
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Movement_Update_m4B99F519DF0A29B476F90FE4314A770CD53EC418 (Movement_t7ED030E814A2C7E091389CFDABC85C6995DD35E7* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7* L_0 = (&__this->___movement_6);
		float L_1;
		...
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7* L_2 = (&__this->___movement_6);
		float L_3;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void playerMovementJoystick_Update_mD6BB86FA004B721B1976795660A4FC9F9E973342 (playerMovementJoystick_t135E21D61161E3ED24468584A13EC40D82073A41* __this, const RuntimeMethod* method) 
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		...
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteral5526E05109630C0E260028AD6D6D0A7DB25F0BF3);
		...
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteral99931AC25F6D28C7349F672724384FD0D4F76340);
		s_Il2CppMethodInitialized = true;
	}
	{
		// if(xActual < (int)transform.position.x)
		int32_t L_0 = __this->___xActual_4;
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_1;
		L_1 = Component_get_transform_m2919A1D81931E6932C7F06D4C2F0AB8DDA9A5371(__this, NULL);
		NullCheck(L_1);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_2;
		L_2 = Transform_get_position_m69CD5FA214FDAE7BB701552943674846C220FDE1(L_1, NULL);
		float L_3 = L_2.___x_2;
		if ((((int32_t)L_0) >= ((int32_t)il2cpp_codegen_cast_double_to_int<int32_t>(L_3))))
		{
			goto IL_0029;
		}
	}
	{
		...
		NullCheck(L_4);
		Animator_SetTrigger_mC9CD54D627C8843EF6E159E167449D216EF6EB30(L_4, _stringLiteral64FB9A957A6173E2C507D6355FB5425135847B8F, NULL);
	}

IL_0029:
	{
		// if(xActual > (int)transform.position.x){
		int32_t L_5 = __this->___xActual_4;
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_6;
		...
		if ((((int32_t)L_5) <= ((int32_t)il2cpp_codegen_cast_double_to_int<int32_t>(L_8))))
		{
			goto IL_0052;
		}
	}
	{
		...
		NullCheck(L_9);
		Animator_SetTrigger_mC9CD54D627C8843EF6E159E167449D216EF6EB30(L_9, _stringLiteral5A09B4D67FCE0A752E1575AA20BB3969E11DF7D0, NULL);
	}

IL_0052:
	{
		// if(yActual < (int)transform.position.y)
		int32_t L_10 = __this->___yActual_5;
		...
		if ((((int32_t)L_10) >= ((int32_t)il2cpp_codegen_cast_double_to_int<int32_t>(L_13))))
		{
			goto IL_007b;
		}
	}
	{
		...
		Animator_t8A52E42AE54F76681838FE9E632683EF3952E883* L_14 = __this->___anim_6;
		NullCheck(L_14);
		Animator_SetTrigger_mC9CD54D627C8843EF6E159E167449D216EF6EB30(L_14, _stringLiteral5526E05109630C0E260028AD6D6D0A7DB25F0BF3, NULL);
	}

IL_007b:
	{
		// if(yActual > (int)transform.position.y){
		int32_t L_15 = __this->___yActual_5;
		...
		if ((((int32_t)L_15) <= ((int32_t)il2cpp_codegen_cast_double_to_int<int32_t>(L_18))))
		{
			goto IL_00a4;
		}
	}
	{
		...
		NullCheck(L_19);
		Animator_SetTrigger_mC9CD54D627C8843EF6E159E167449D216EF6EB30(L_19, _stringLiteral99931AC25F6D28C7349F672724384FD0D4F76340, NULL);
	}
...
IL_00a4:
	{
		...
		__this->___xActual_4 = il2cpp_codegen_cast_double_to_int<int32_t>(L_22);
		// yActual = (int) transform.position.y;
		...
		__this->___yActual_5 = il2cpp_codegen_cast_double_to_int<int32_t>(L_25);
		// Debug.Log(xActual);
		int32_t L_26 = __this->___xActual_4;
		int32_t L_27 = L_26;
...
{
	{
		...
		MovementJoystick_t2017A611A0BFF544D9C0FE539249F863DE7250CA* L_0 = __this->___movementJoystick_7;
		NullCheck(L_0);
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7* L_1 = (&L_0->___joystickVec_6);
		float L_2 = L_1->___x_0;
		float L_3 = __this->___moveSpeed_9;
		MovementJoystick_t2017A611A0BFF544D9C0FE539249F863DE7250CA* L_4 = __this->___movementJoystick_7;
		NullCheck(L_4);
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7* L_5 = (&L_4->___joystickVec_6);
		float L_6 = L_5->___y_1;
		float L_7 = __this->___moveSpeed_9;
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_8;
